...
#define goto_cleanup_if_failed(__result__, __goto_label__) if((result = (__result__)) != VV_SUCCESS) { vv_print_error(__result__, __FILE__, __LINE__, __FUNCTION__); goto __goto_label__; }
